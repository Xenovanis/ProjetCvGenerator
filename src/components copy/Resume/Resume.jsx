...
const Resume = forwardRef((props, ref) => {
  ...
  const sectionDiv = {
    ...
    [sections.language]: (
      <div
        ...
        className={`${styles.section} ${
          info.language?.sectionTitle ? "" : styles.hidden
        }`}
      >
        <div className={styles.sectionTitle}>
        ...
        <div className={styles.content}>
          {info.language?.points?.length > 0 ? (
            <ul className={styles.numbered}>
              {info.language?.points?.map((elem, index) => (
                <li className={styles.point} key={elem + index}>
                  {elem}
                </li>
              ))}
    ...
    [sections.skill]: (
      ...
      >
        ...
        <div className={styles.content}>
          <p className={styles.overview}>{info?.skill?.detail}</p>
        </div>
      </div>
    ),
  };
  ...
  useEffect(() => {
    setColumns([
      ...
      [sections.workExp, sections.language, sections.skill],
    ]);
  }, []);
